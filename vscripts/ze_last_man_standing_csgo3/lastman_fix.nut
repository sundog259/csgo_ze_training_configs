...
function MapStart()
{
	...
	else if(STAGE == 5)
	{
		...
		EntFire("console","Command","zr_class_modify zombies health_regen_interval 2",0.00,null);
		EntFire("console","Command","zr_class_modify zombies health_regen_amount 80",0.00,null);
	...
	{
		EntFire("console","Command","sm_cvar zr_infect_mzombie_ratio 7",1.00,null);
		EntFire("console","Command","zr_class_modify zombies health_regen_interval 0.2",0.00,null);
		EntFire("console","Command","zr_class_modify zombies health_regen_amount 15",0.00,null);
		EntFire("Global_GameText_Stage_Start","FireUser1","",2.00,null);
...
function SetPlayerScript()
{
	...
	while(null != (Fpl = Entities.FindByClassname(Fpl, "player")))
	{
		if(Fpl.GetHealth() > 0 && Fpl.IsValid())
		{
			...
			{
				EntFireByHandle(Fpl,"RunScriptFile","ze_last_man_standing_csgo3/player_lastman_cn.nut",0.00,Fpl,Fpl);
			}
		}
	}
