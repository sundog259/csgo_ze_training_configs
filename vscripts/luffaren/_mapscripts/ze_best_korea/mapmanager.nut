...
function StartMap()
{
	...
	if(stage==1)
	{
		...
		EntFire("s3_ramranch_fix","Kill","",0.10,null);
		EntFire("s3_ramranch_ass","Kill","",0.10,null);
		EntFire("s2_bossgatefix","Kill","",0.10,null);
		EntFire("s2_killdoorhug*","Kill","",0.10,null);
		EntFire("s2_kim","Kill","",0.10,null);
		EntFire("s2_wallfix","Kill","",0.10,null);
		EntFire("s2_kimfacefix","Kill","",0.10,null);
		EntFire("stage_counter","Add","1",60.00,null);
	}
	else if(stage==2)
	{
